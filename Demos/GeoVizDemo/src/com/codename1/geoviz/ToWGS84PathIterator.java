 ...
 * a shape.  This iterator converts points from (x,y) coordinates in projection space
 * to (lng,lat) pairs.
 * @author shannah
 */
public class ToWGS84PathIterator implements PathIterator {
    
    private final PathIterator source;
    private final Projection projection;
    
    public ToWGS84PathIterator(PathIterator source, Projection projection){
        this.source = source;
    ...
    public int currentSegment(float[] coords) {
        ...
        Coord tmp = projection.toWGS84(new Coord(coords[0], coords[1], true));
