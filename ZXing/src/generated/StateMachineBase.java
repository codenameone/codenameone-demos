...
public abstract class StateMachineBase extends UIBuilder {
    ...
    public com.codename1.ui.Button findScan(Container root) {
        return (com.codename1.ui.Button)findByName("scan", root);
    }
    ...
    protected void handleComponentAction(Component c, ActionEvent event) {
        ...
        if(rootContainerName.equals("GUI 1")) {
            if("scan".equals(c.getName())) {
                onGUI1_ScanAction(c, event);
                return;
            }
        }
    }
